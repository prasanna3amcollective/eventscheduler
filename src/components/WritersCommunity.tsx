...
import { IronStylus, AssemblyCircle, ThreadDivider } from './WritersIcons';
        ...
        <div className="writers-wrapper">
            ...
            <div className="writers-container">
                ...
                <section className="writers-section">
                    <h2>
                        <IronStylus className="ink-icon" /> What is This?
                    </h2>
                ...
                <section className="writers-section">
                    <h2>
                        <IronStylus className="ink-icon" /> Why?
                    </h2>
                ...
                <section className="writers-section">
                    <h2>
                        <AssemblyCircle className="ink-icon" /> For Whom?
                    </h2>
                ...
                <section className="writers-section">
                    <h2>
                        <IronStylus className="ink-icon" /> How?
                    </h2>
